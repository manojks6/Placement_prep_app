    ...
    {/* TopNavBar */}
      ...
      <div class=" bg-gray-900  flex flex-wrap items-center justify-between mx-auto p-4">
            <ul class="font-medium flex space-x-14 ml-20 p-4 pl-10  border-gray-100  ">
                  <li>
                  <a href="#" class=" text-teal-500 hover:text-white -ml-10" >Top 100 Qustions</a>
                  </li>
                  <li>
                  <a href="#" class=" text-teal-500 hover:text-white" >TopicWise List</a>
                  </li>
                  <li>
                  <a href="#" class=" text-teal-500 hover:text-white" >Tutorial</a>
                  </li>
                  <li>
